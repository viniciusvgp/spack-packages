...
class Screen(AutotoolsPackage, GNUMirrorPackage):
    ...
    depends_on("autoconf@2.71:", type="build", when="@5:")
    depends_on("autoconf@2.60:", type="build", when="@4.9:")
    depends_on("automake", type="build", when="@4.9:")
    depends_on("libtool", type="build", when="@4.9:")
    depends_on("ncurses")
    depends_on("libxcrypt", when="@3.9:")
    depends_on("linux-pam", when="@5: platform=linux")
