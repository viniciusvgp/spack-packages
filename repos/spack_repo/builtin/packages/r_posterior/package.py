...
class RPosterior(RPackage):
    ...
    version("1.7.0", sha256="430305bcceea4c09e04935e9b48ac1510fed88e89caded882846dc0d225780dc")
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("r-rlang@1.0.6:", when="@1.4.1:")
        depends_on("r-rlang@0.4.7:")
        depends_on("r-tibble@3.1.0:", when="@1.4.1:")
        depends_on("r-tibble@3.0.0:")
        depends_on("r-vctrs@0.5.0:", when="@1.4.1:")
        depends_on("r-vctrs")
        depends_on("r-tensora")
        depends_on("r-pillar")
        depends_on("r-distributional")
