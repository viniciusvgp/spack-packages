...
class RSass(RPackage):
    ...
    version("0.4.10", sha256="4adb4c243f74d811276529e346deaa064bce28dbfbb837208fc85f2c47b79b30")
    ...
    with default_args(type=("build", "run")):
        depends_on("r-fs@1.2.4:", when="@0.4.7:")
        depends_on("r-fs")
        depends_on("r-rlang@0.4.10:")
        depends_on("r-htmltools@0.5.1:")
        depends_on("r-r6")
