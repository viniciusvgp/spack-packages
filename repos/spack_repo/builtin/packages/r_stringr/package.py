...
class RStringr(RPackage):
    ...
    version("1.6.0", sha256="24f2fc5df980a7eb888659e22b9744d2316c558624015c7a7cd8c3ce3e370064")
    ...
    with default_args(type=("build", "run")):
        depends_on("r@4.1:", when="@1.6.0:")
        depends_on("r@3.6:", when="@1.5.1:")
        depends_on("r@3.3:", when="@1.5.0:")
        depends_on("r@3.1:")

        depends_on("r-cli", when="@1.5.0:")
        depends_on("r-glue@1.6.1:", when="@1.5.0:")
        depends_on("r-glue@1.2.0:", when="@1.3.0:")
        depends_on("r-lifecycle@1.0.3:", when="@1.5.0:")
        depends_on("r-magrittr")
        depends_on("r-rlang@1.0.0:", when="@1.5.0:")
        depends_on("r-stringi@1.5.3:", when="@1.5.0:")
        depends_on("r-stringi@1.1.7:")
        depends_on("r-vctrs@0.4.0:", when="@1.5.1:")
        depends_on("r-vctrs", when="@1.5.0:")
