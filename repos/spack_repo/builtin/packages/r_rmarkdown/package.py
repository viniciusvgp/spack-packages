...
class RRmarkdown(RPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("r-bslib@0.2.5.1:", when="@2.14:")
        depends_on("r-evaluate@0.13:")
        depends_on("r-fontawesome@0.5.0:", when="@2.21:")
        depends_on("r-htmltools@0.5.1:", when="@2.16:")
        depends_on("r-htmltools@0.3.5:")
        depends_on("r-jquerylib", when="@2.11:")
        depends_on("r-jsonlite")
        depends_on("r-knitr@1.43:", when="@2.26:")
        depends_on("r-knitr@1.22:")
        depends_on("r-tinytex@0.31:", when="@2.8:")
        depends_on("r-tinytex@0.11:", when="@1.10:")
        depends_on("r-xfun@0.36:", when="@2.21:")
        depends_on("r-xfun@0.30:", when="@2.14:")
        depends_on("r-xfun@0.21:", when="@2.8:")
        depends_on("r-xfun@0.15:", when="@2.6:")
        depends_on("r-xfun", when="@1.13:")
        depends_on("r-yaml@2.1.19:")

        # Historical dependencies
        depends_on("r-rprojroot", when="@1.3:1.7")
        depends_on("r-mime", when="@1.8:1.14")
        depends_on("r-catools", when="@:1.7")
        depends_on("r-base64enc", when="@:1.14")
        depends_on("r-stringr@1.2.0:", when="@1.6:2.25")
