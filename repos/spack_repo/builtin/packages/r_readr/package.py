...
class RReadr(RPackage):
    ...
    version("2.2.0", sha256="8025d797c183e12ad5ebe4af891dbcb5a8e9bd53aa4765006eb25a07f9a9f473")
    ...
    with default_args(type=("build", "run")):
        depends_on("r@4.1:", when="@2.2.0:")
        depends_on("r@3.6:", when="@2.1.5:")
        depends_on("r@3.5:", when="@2.1.4:")
        depends_on("r@3.4:", when="@2.1.3:")
        depends_on("r@3.1:", when="@1.3.0:")
        depends_on("r@3.0.2:")

        # no lower version restriction anymore in new release -> leave it anyway
        depends_on("r-cli@3.2.0:", when="@2.1.3:")
        depends_on("r-cli@3.0.0:", when="@2.1.2:")
        depends_on("r-cli", when="@1.4.0:")
        depends_on("r-clipr", when="@1.2.0:")
        depends_on("r-crayon", when="@1.3.1:")
        depends_on("r-glue", when="@2.2.0:")
        depends_on("r-hms@0.4.1:")
        # no lower version restriction anymore in new release -> leave it anyway
        depends_on("r-lifecycle@0.2.0:", when="@2:")
        depends_on("r-lifecycle", when="@1.4.0:")
        depends_on("r-r6")
        depends_on("r-rlang", when="@1.4.0:")
        depends_on("r-tibble")
        depends_on("r-vroom@1.7.0:", when="@2.2.0:")
        depends_on("r-vroom@1.6.0:", when="@2.1.3:")
        depends_on("r-vroom@1.5.6:", when="@2.1.1:")
        depends_on("r-vroom@1.5.4:", when="@2.0.1:")
        depends_on("r-vroom@1.5.2:", when="@2.0.0")
        depends_on("r-withr", when="@2.2.0:")
        depends_on("r-cpp11", when="@1.4.0:")
        depends_on("r-tzdb@0.1.1:", when="@2:")

        # Historical dependencies
        depends_on("r-bh", when="@:1")
        depends_on("r-rcpp@0.12.0.5:", when="@:1.3.1")
