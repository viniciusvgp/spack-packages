...
class PyBoto3(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-botocore@1.34.44:1.34", when="@1.34.44")
        depends_on("py-botocore@1.29.26:1.29", when="@1.26")
        depends_on("py-botocore@1.28.5:1.28", when="@1.25")
        depends_on("py-botocore@1.27.96:1.27", when="@1.24")
        depends_on("py-botocore@1.26.10:1.26", when="@1.23")
        depends_on("py-botocore@1.25.13:1.25", when="@1.22")
        depends_on("py-botocore@1.24.46:1.24", when="@1.21")
        depends_on("py-botocore@1.23.54:1.23", when="@1.20")
        depends_on("py-botocore@1.22.12:1.22", when="@1.19")
        depends_on("py-botocore@1.21.65:1.21", when="@1.18")
        depends_on("py-botocore@1.20.27:1.20", when="@1.17")
        depends_on("py-botocore@1.13.50:1.13", when="@1.10")
        depends_on("py-botocore@1.12.253:1.12", when="@1.9")
        ...
        depends_on("py-s3transfer@0.8.2:0.8", when="@1.33.4:1.33")
        depends_on("py-s3transfer@0.8", when="@1.29.7:1.33.3")
        depends_on("py-s3transfer@0.7", when="@1.28.55:1.29.6")
        depends_on("py-s3transfer@0.6", when="@1.24:1.28.54")
        depends_on("py-s3transfer@0.5", when="@1.18:1.23")
        depends_on("py-s3transfer@0.3", when="@1.17")
        depends_on("py-s3transfer@0.2", when="@:1.10")
