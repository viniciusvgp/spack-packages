...
class RNlme(RPackage):
    ...
    version("3.1-169", sha256="51b92f1b543d2eb5915478965dab05a9094e1675a160138d49963eb3a0e7fdb8")
    ...
    with default_args(type=("build", "run")):
        depends_on("r@3.6.0:", when="@3.1-165:")
        depends_on("r@3.4.0:", when="@3.1-135.5:")
        depends_on("r@3.5.0:", when="@3.1-134:3.1-135")
        depends_on("r@3.3.0:", when="@3.1-131.1")
        depends_on("r@3.0.2:")
